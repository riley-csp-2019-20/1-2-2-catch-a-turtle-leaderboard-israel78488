...
# update_leaderboard by inserting the current player and score to the list at the correct position
...
# update_leaderboard("a122_leaderboard.txt",
# ["abba", "nawa", "qadash"], [15,20,25], "malak", 7)
...
def draw_leaderboard(leader_names, leader_scores, high_scorer, turtle_object, player_score):
  ...
  if (player_score < silver_score and player_score >=bronze_score):
